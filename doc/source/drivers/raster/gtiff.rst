...
.. config:: COMPRESS_OVERVIEW
   ...
   See `Creation Options COMPRESS <#creation-options>`__ section.
...
.. config:: GDAL_TIFF_INTERNAL_MASK
   ...
   See `Internal nodata
   masks <#internal_mask>`__ section

.. config:: GDAL_TIFF_INTERNAL_MASK_TO_8BIT
   :choices: TRUE, FALSE
   :default: TRUE

   See `Internal nodata masks <#internal_mask>`__ section.
...
.. config:: GDAL_TIFF_OVR_BLOCKSIZE
   ...
   See `Overviews <#overviews>`__ section.
...
.. config:: GDAL_GEOREF_SOURCES
   ...
   See `Georeferencing <#georeferencing>`__ paragraph.
